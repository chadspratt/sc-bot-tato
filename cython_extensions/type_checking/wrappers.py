...
from cython_extensions.general_utils import (
    cy_structure_pending as _cy_structure_pending,
)
from cython_extensions.general_utils import (
    cy_structure_pending_ares as _cy_structure_pending_ares,
)
...
def cy_find_aoe_position(effect_radius, targets, min_units: int = 1, bonus_tags=None):
    ...
    return _cy_find_aoe_position(effect_radius, targets, bonus_tags)
